...
calibrated_transient = '03_21_2017_105deg_168.mat';
load(calibrated_transient);
filename = ['../../dataset3-gt/PlaneCharacterization/' calibrated_transient];
...
% gt_p = [0;1.17; -0.30];
% gt_n = [0;-1/2;sqrt(3)/2];
% p = [1 1 -1 -1; gt_p(2) gt_p(2)-0.5 gt_p(2)-0.5 gt_p(2); zeros(1,4)];
% 
% for i = 1:size(p,2)
%     p(3,i) = (gt_p'*gt_n - p(1,i)*gt_n(1) - p(2,i)*gt_n(2))/gt_n(3);
% end
