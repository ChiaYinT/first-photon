function Obj = gatherCorrectedData4( Detector_Bias_Calibration_file,data_path,SourceLocation,V_Detector,V_Sources)
...
withObj = load(data_path);


calib_bias = aggregateAllTiming(data_calib_bias);
withObj =  withObj.countsbuffer;
Obj        = withObj;
